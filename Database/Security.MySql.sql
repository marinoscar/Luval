...
(UserId, Provider, ProviderType, ProviderKey, Version, UtcCreatedOn, UtcUpdatedOn)
SELECT Id, 'Application' As Porvider, 'Application' As ProviderType, Id As ProviderKey, 1, utc_timestamp(), utc_timestamp()
